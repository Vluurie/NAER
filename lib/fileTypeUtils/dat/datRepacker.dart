...
Future<void> repackDat(String datDir, String exportPath) async {
  try {
    ...
    for (var value in hashData.bucketOffsets) datBytes.writeUint16(value);
    for (var value in hashData.hashes) datBytes.writeUint32(value);
    for (var value in hashData.indices) datBytes.writeUint16(value);

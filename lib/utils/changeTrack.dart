...
class FileChange {
  ...
  String? originalFilePath; // for modified files, null for others
  ...
  static Future<void> undoChanges() async {
    for (FileChange change in changes.reversed) {
      try {
        if (change.action == 'create' &&
          ...
          // Handle restoration of deleted files if necessary
          // ...
        }
      } catch (e) {
    ...
    changes.clear(); // Clear changes after processing all changes
  }
